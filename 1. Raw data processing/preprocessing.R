...
# Script to read the raw files from CellRanger and create the Seurat Object. 
# For each sample, we used different filtering during quality control
# depending on the number of cells retrieved and the mitochondrial proportion.
...
HD19002_1.data <- Read10X(data.dir = "~/SCC190416AA/SCC190416AA_HD19002_BM/filtered_feature_bc_matrix/")
...
HD19002_Enriched.data <- Read10X(data.dir = "~/SCC190416AA/SCC190416AA_HD19002_BM_CD34_MSC/filtered_feature_bc_matrix/")
...
FPD1_1.data <- Read10X(data.dir = "~/CEL181127AA/CEL181127AA_TB-BM_rep_1/filtered_feature_bc_matrix/")
...
FPD1_2.data <- Read10X(data.dir = "~/CEL181127AA/CEL181127AA_TB-BM_rep_2/filtered_feature_bc_matrix/")
...
FPD1_3.data <- Read10X(data.dir = "~/CEL181127AA/CEL181127AA_TB-BM_rep_3/filtered_feature_bc_matrix/")
...
FPD1_4.data <- Read10X(data.dir = "~/CEL181127AA/CEL181127AA_TB-BM_rep_4/filtered_feature_bc_matrix/")
...
####### FPD1 Enriched rep 1
FPD1_Enriched_1.data <- Read10X(data.dir = "~/SCL181127AA/SCL181127AA_AO_BM_rep_1/filtered_feature_bc_matrix/")
...
####### FPD1 Enriched rep 2
FPD1_Enriched_2.data <- Read10X(data.dir = "~/SCL181127AA/SCL181127AA_AO_BM_rep_2/filtered_feature_bc_matrix/")
...
####### FPD2 Enriched rep 1
FPD2_Enriched_1.data <- Read10X(data.dir = "~/SCC190314AA/SCC190314AA_FPD_2_1/filtered_feature_bc_matrix/")
...
####### FPD2 Enriched rep 2
FPD2_Enriched_2.data <- Read10X(data.dir = "~/SCC190314AA/SCC190314AA_FPD_2_2/filtered_feature_bc_matrix/")
...
####### FPD3 Enriched rep 1
FPD3_Enriched_1.data <- Read10X(data.dir = "~/SCC190314AA/SCC190314AA_FPD_3_1/filtered_feature_bc_matrix/")
...
####### FPD3 Enriched rep 2
FPD3_Enriched_2.data <- Read10X(data.dir = "~/SCC190314AA/SCC190314AA_FPD_3_2/filtered_feature_bc_matrix/")
...
####### FPD4 Enriched rep 1
FPD4_Enriched_1.data <- Read10X(data.dir = "~/SCC190314AA/SCC190314AA_FPD_4_1/filtered_feature_bc_matrix/")
...
####### FPD4 Enriched rep 2
FPD4_Enriched_2.data <- Read10X(data.dir = "~/SCC190314AA/SCC190314AA_FPD_4_2/filtered_feature_bc_matrix/")
...
####### FPD6 enriched rep 1
FPD6_Enriched_1.data <- Read10X(data.dir = "~/CEL190731AA/CEL190731AA_FPD6_BM_MNC_CD34_MSC/filtered_feature_bc_matrix/")
...
FPD7_1.data <- Read10X(data.dir = "~/CEL190823AA/CEL190823AA_FPD7_MNC/filtered_feature_bc_matrix/")
...
####### FPD7 enriched rep 1
FPD7_Enriched_1.data <- Read10X(data.dir = "~/CEL190823AA/CEL190823AA_FPD7_MNC_plus_CD34_plus_MSC/filtered_feature_bc_matrix/")
...
####### FPD7 unenriched rep 1
FPD7_CD11BCD14_1.data <- Read10X(data.dir = "~/CEL190823AA/CEL190823AA_FPD7_Cd11b_plus_CD14_plus/filtered_feature_bc_matrix/")
...
####### FPD7 enriched rep 1
FPD7_CD11BCD14minus_1.data <- Read10X(data.dir = "~/CEL190823AA/CEL190823AA_FPD7_Cd11b_plus_CD14_minus/filtered_feature_bc_matrix/")
...
####### FPD7 unenriched rep 1
FPD8_1.data <- Read10X(data.dir = "~/CEL190905AA/CEL190905AA_FPD8_MNC/filtered_feature_bc_matrix/")
...
####### FPD7 unenriched rep 1
FPD8_Enriched_1.data <- Read10X(data.dir = "~/CEL190905AA/CEL190905AA_FPD8_MNC_plus_Cd34_plus_MSC/filtered_feature_bc_matrix/")
...
####### FPD7 unenriched rep 1
HD4_1.data <- Read10X(data.dir = "~/CEL190905AA/CEL190905AA_HD19-004_MNC/filtered_feature_bc_matrix/")
...
####### FPD7 unenriched rep 1
HD4_Enriched_1.data <- Read10X(data.dir = "~/CEL190905AA/CEL190905AA_HD19-004_MNC_plus_Cd34_plus_MSC/filtered_feature_bc_matrix/")
...
####### FPD7 unenriched rep 1
FPD9_1.data <- Read10X(data.dir = "~/CEL190911AA/CEL190911AA_FPD9/filtered_feature_bc_matrix/")
...
####### FPD7 unenriched rep 1
FPD9_Enriched_1.data <- Read10X(data.dir = "~/CEL190911AA/CEL190911AA_FPD9_CD34plus_MSC/filtered_feature_bc_matrix/")
...
####### FPD7 unenriched rep 1
FPD10_1.data <- Read10X(data.dir = "~/CEL190911AA/CEL190911AA_FPD10/filtered_feature_bc_matrix/")
...
####### FPD7 unenriched rep 1
FPD10_Enriched_1.data <- Read10X(data.dir = "~/CEL190911AA/CEL190911AA_FPD10_CD34plus_MSC/filtered_feature_bc_matrix/")
...
###### FPD7 unenriched rep 1
HD_4_2.data <- Read10X(data.dir = "~/CEL190823AA/CEL190823AA_Batch_3_HD_4_v2/filtered_feature_bc_matrix/")
...
####### FPD7 unenriched rep 1
HD5.data <- Read10X(data.dir = "~/CEL190916AA/CEL190916AA_HD19005/filtered_feature_bc_matrix/")
...
####### FPD7 unenriched rep 1
FPD12.data <- Read10X(data.dir = "~/CEL191022AA/CEL191022AA_FPD12_MNC/filtered_feature_bc_matrix/")
...
####### FPD7 unenriched rep 1
HD6_1.data <- Read10X(data.dir = "~/CEL190911AA/CEL190911AA_FPD10_CD34plus_MSC/filtered_feature_bc_matrix/")
